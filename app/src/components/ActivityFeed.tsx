...
import { ChevronRight, Plus, Move, Paperclip, Flag, Calendar, User, FileText, Type, Folder } from 'lucide-react';
...
/** Feed de actividad global con paginación keyset, agrupado por día. Reutilizable
 *  (página dedicada y pestaña Actividad del Resumen). */
